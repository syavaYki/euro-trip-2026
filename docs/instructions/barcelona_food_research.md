...
| **Draps** [📍](https://maps.google.com/?q=Draps+Carrer+de+la+Cort+Reial+2+Girona+Spain) (Girona) | Barri Vell local favourite — *menú del dia* with the wine included | C/ de la Cort Reial 2, Girona | €13–18 | **Day 5 Girona lunch pick**, two streets off Pl. de la Independència |
...
| **Day 5** (Sun Aug 30 — Girona or city) | Near hotel (or pre-Mass pastry) | Girona: **Draps** (Cort Reial 2) or **El Carrito** (La Barca 10) ⭐ — the Pl. de la Independència terraces are the fallback, not the pick · **xuixo** + **Rocambolesc** · City: Sarrià lunch | **7 Portes** farewell ~21:00 🟠 **still unbooked** (€40–60/pp) — or **Bodega La Palma** / Carrer de Blai at a third of the price | ⚠️ Sunday closures: Cova Fumada, Quimet & Quimet, Cal Pep, Boqueria all shut |
