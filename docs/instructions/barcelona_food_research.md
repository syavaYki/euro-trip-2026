...
| 4 | **Bar del Pla** [📍](https://maps.google.com/?q=Bar+del+Pla+Barcelona+Spain) ⭐ | Vaulted-brick Catalan tapas bar, local crowd two streets from the Picasso queue | C/ de la Montcada 2, El Born | €20–28 | Mon–Thu 12:00–23:00, Fri–Sat till 24:00 (Sun — verify) | Croquetes de pernil + bravas + a glass of the house red; ❌ not on this itinerary now — kept as the El Born reference if a morning frees up |
...
| **Draps** [📍](https://maps.google.com/?q=Draps+Carrer+de+la+Cort+Reial+2+Girona+Spain) (Girona) | Barri Vell local favourite — *menú del dia* with the wine included | C/ de la Cort Reial 2, Girona | €13–18 | Day 5 backup, two streets off Pl. de la Independència. ⚠️ *menú del dia* is usually weekday-only |
...
| **Day 3** (Fri Aug 28 — Montserrat) | Quick, near hotel / Pl. d'Espanya | **Monastery buffet** (included in Tot ticket) 13:30 after the choir | Same near-hotel shortlist — **el Xuletò / El Tastet de l'Artur**, two streets off the basilica | Mountain day — mató + honey from the farmers' stalls is the snack |
| **Day 4** (Sat Aug 29 — **Girona**) | Xuixo ⭐ on Carrer Nou / Rambla de la Llibertat | 🔴 **Bartali Pizza Co.** 14:00 — **booking must move from Sun 30 to Sat 29**, ☎️ +34 972 21 09 91 · backups **Draps** / **El Carrito** ⭐ | Post-vigil-Mass: **La Bendita** ⭐ (2 min from the flat) or **el Xuletò** | ❌ Rocambolesc dropped on the day — the 15:30 stop is **cold brew at Espresso Mafia** (C/ de la Cort Reial 5) or a *vermut* on the Rambla. The gelato stays here as an option, not a plan |
...
| €15–25 (lunch) | Bar Jai-Ca, Ciudad Condal, La Pepita, Gràcia menú del día (La Cova Fumada — ⚠️ closed Sundays, so not on our dates) |
...
| Category | Top Picks |
|----------|-----------|
| ⭐⭐ Can't miss this trip | **Bar Jai-Ca** bombas (Cova Fumada is shut Sundays), La Bendita after the vigil Mass, Carrer de Blai with the kids |
