...
>
> **Family rules:** churches, crypts, parks, rowboats, viewpoints, gelato — yes. Bars and clubs — no. Kid-magnets this city delivers: the Royal Armoury, the Egyptian temple at sunset, Retiro boats, peacocks, a turnstile that dispenses cookies from invisible nuns.

---

## 🏛️ Main Attractions

| Name | Why go | Cost (2026) | Hours (our week) | Book? | Tip |
|------|--------|-------------|------------------|-------|-----|
| **Museo del Prado** [📍](https://maps.google.com/?q=Museo+del+Prado+Madrid+Spain) ⭐⭐ | One of the world's great museums — *Las Meninas* (Rm 12), Goya's Black Paintings (67–68), Bosch's *Garden* (56A), El Greco | €15 · €7.50 students 18–25 · under 18 free | Mon–Sat 10–20, Sun 10–19 | ✅ NOW — [entradas.museodelprado.es](https://entradas.museodelprado.es/) | Booked slot = Puerta de los Jerónimos entrance. Go to Las Meninas FIRST at 10:00 — near-private. Free 18–20h window has its own long queue; skip it |
...
| **Templo de Debod** [📍](https://maps.google.com/?q=Templo+de+Debod+Madrid+Spain) ⭐⭐ | A genuine 2nd-c BC Egyptian temple, rebuilt facing the Madrid sunset over reflecting pools | Free (interior too) | Terrace always; interior Tue–Sun 10–19 (last 18:30), closed Mon | Interior: timed slot via madrid.es | **Sunset Sep 2 ≈ 20:47** — claim a west-facing spot by 19:50. Picnic on the Parque del Oeste grass beside it |
| **El Rastro** [📍](https://maps.google.com/?q=El+Rastro+Madrid+Spain) | Legendary Sunday flea market — 3,500+ stalls since the 16th century | Free | Sun + holidays 09–15 **only** | ❌ | **Not this trip** — we have no Sunday (Sep 5 departure is Saturday). On the list for a return |

**Legend:** ⭐ essential · ⭐⭐ top priority · Book? = ✅ prebook / ❌ walk-up

---

## ⛪ Churches & Religious Sites (family priority)

> Mostly free, mostly empty, uniformly extraordinary. Morning light (10:00–11:00) for domes; ~19:00 for candles and locals. Mass times in the master itinerary's Mass section.
...
| **Convento del Corpus Christi (Las Carboneras)** [📍](https://maps.google.com/?q=Convento+del+Corpus+Christi+Las+Carboneras+Madrid+Spain) ⭐ | Cloistered nuns sell cookies through a **blind revolving turnstile** — you order, pay, and biscuits appear from unseen hands | Cookies €8–15/box | Daily 09:30–13 + 16–18:30 | 3 min from Plaza Mayor; ring the bell, speak into the grille, trust the wheel. The girls will talk about it for years |

---

## ⚰️ Historic Cemeteries (family priority)

> Both great Victorian necropolises are free, silent, and unvisited. Unscheduled this trip — they need a half-day the itinerary doesn't have; keep for a return or swap into a collapsed plan.

| Name | Why go | Cost | Hours | Tip |
|------|--------|------|-------|-----|
| **Cementerio de la Almudena** [📍](https://maps.google.com/?q=Cementerio+de+la+Almudena+Madrid+Spain) ⭐ | **Spain's largest cemetery** — ~5 million graves, more than Madrid's living population; pantheon avenues in every style from Egyptian Revival to Art Nouveau | Free | Daily ~08:00–18:30+ | Metro La Almudena (L2); aim for Avenida Principal's pantheons and the Egyptian pyramid of the Marqueses de Hinojares |
| **Sacramental de San Isidro** [📍](https://maps.google.com/?q=Cementerio+Sacramental+de+San+Isidro+Madrid+Spain) | Madrid's Père-Lachaise (1811) — Romantic mausoleums; Goya's first grave | Free | Daily ~08:00–18:30+ | 20-min walk over the river from La Latina; the Patio de la Purísima is the beautiful core |
| **Panteón de los Hombres Ilustres** [📍](https://maps.google.com/?q=Pante%C3%B3n+de+los+Hombres+Ilustres+Madrid+Spain) | Tiny neo-Byzantine pantheon of 19th-c prime ministers — six spectacular marble tombs, zero visitors | Free | Tue–Sat 10–13:30 + 16–18:30, Sun 10–15, closed Mon | 5 min from Atocha — the only cemetery stop that fits a spare 30 min on the museum axis |
...
| Name | Why go | Cost | Hours (our week) | Tip |
|------|--------|------|------------------|-----|
| **Matadero Madrid** [📍](https://maps.google.com/?q=Matadero+Madrid+Madrid+Spain) ⭐ | 1920s slaughterhouse turned arts campus — **5 min from our apartment** | Free (most halls) | Campus daily; exhibition naves ~Tue–Fri 17–21, Sat–Sun 12–21, closed Mon | Day 1 evening stroll territory; check the façade posters for whatever's on our week |
...
| ~~**Teleférico de Madrid**~~ [📍](https://maps.google.com/?q=Telef%C3%A9rico+de+Madrid+Spain) | 2.5 km cable car over the Manzanares — normally the classic kid ride | — | ⚠️ **CLOSED since 2022, structural repairs, no reopening date** | Check teleferico.emtmadrid.es only if you're curious; assume it's off the board |
...
| Name | Why go | Cost | Hours (our week) | Tip |
|------|--------|------|------------------|-----|
| **Templo de Debod terrace** ⭐⭐ | The sunset view of the trip — see Main Attractions | Free | Always | Scheduled: Day 2, 19:45 |
| **Mirador de Madrid — Cibeles rooftop** [📍](https://maps.google.com/?q=Palacio+de+Cibeles+mirador+Madrid+Spain) ⭐ | 360° from the 8th floor of the wedding-cake city hall | €3; under 14 free | Tue–Sun 10:30–14 + 16–19:30, closed Mon | ⚠️ Shuts ~19:30 — it's a daytime view for us, not a sunset one; pocket option only |
| **Círculo de Bellas Artes rooftop** [📍](https://maps.google.com/?q=C%C3%ADrculo+de+Bellas+Artes+Madrid+Spain) | The famous Gran Vía panorama | €5; under 12 free | Daily ~10–22 — verify | Rooftop entry is separate from the bar (family-fine); sunset queues are real — go odd hours |
| **Faro de Moncloa** [📍](https://maps.google.com/?q=Faro+de+Moncloa+Madrid+Spain) | 92 m glass tower — the highest public viewpoint in Madrid, and nobody goes | €4; under 7 free | Tue–Sun 09:30–14 + 17–19, closed Mon | Weekday morning = zero wait; only worth the L3/L6 ride if already headed northwest |

---

## 🏘️ Neighbourhoods to Wander

| Name | Vibe | Best for | Walk that works |
|------|------|----------|-----------------|
| **La Latina** [📍](https://maps.google.com/?q=La+Latina+Madrid+Spain) | Medieval lanes + Madrid's densest tapas strip | Day 3 night crawl; church cluster | Plaza de la Paja → San Andrés → (San Francisco el Grande) → Cava Baja for dinner |
| **Malasaña** [📍](https://maps.google.com/?q=Malasa%C3%B1a+Madrid+Spain) | Post-Franco counterculture turned coffee capital | Day 2 afternoon | Plaza del 2 de Mayo → C/ de la Palma → San Antonio de los Alemanes → C/ Fuencarral |
| **Chueca** [📍](https://maps.google.com/?q=Chueca+Madrid+Spain) | Lively, proud, gelato-rich; daytime family-easy | Day 2 pre-Debod | San Antón market → Mistura → Plaza de Chueca → west toward Plaza de España |
