...
- [ ] 🔴 **Lisbon · redeem the Jerónimos voucher — it is NOT a ticket yet.** The four PDFs say *"THIS IS NOT A TICKET · THIS VOUCHER DOES NOT GRANT ENTRY"*: open-dated, valid to **30/01/2027**, **no slot booked**. Log in at **blueticket.meo.pt → Tickets tab** → the **MOSTEIRO DOS JERÓNIMOS — CLAUSTRO** card (*"4 Vouchers"*) → press its **"Schedule"** button → pick **Sun Aug 23, ~13:00** (clear of the 12:00 handover) → the **entry ticket arrives by email**; save it offline. ⚠️ **Not the "Schedule a Visit" tab** — that's for rescheduling tickets you already hold and correctly shows *"You don't have tickets."* Code **38185413** · PIN **1CT468** if a form asks. The gate will not scan the voucher. _Today, before Belém._
