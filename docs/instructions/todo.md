...
- [ ] **Fill oil**
- [ ] **Cut grass**
- [ ] Weigh every bag — 23 kg checked, 8 kg carry-on (TAP weighs at the gate at OPO and LIS)
- [ ] Confirm both checked bags are pre-paid on **all three** TAP segments — OPO→LIS and LIS→BCN bill separately from the transatlantic leg
- [ ] Download every ticket PDF offline (Jerónimos, Regaleira, São Vicente, Palacio Real) — **the confirmation emails are not tickets**
- [ ] Save the Zaragoza lockbox code offline on **two** phones
...
- [ ] 🔴 **Porto · fill the SEF guest-details form — all four of us.** Legally required, goes to the Foreigners & Borders Service: [app.talkguest.com/GuestData/1190/5732321948/BD3E01F](https://app.talkguest.com/GuestData/1190/5732321948/BD3E01F) _Do it today._
- [ ] 🔴 **Porto · message the host with our ETA — and pin down the bag drop.** The instructions say **"enter at 16:00 or later"**, but Booking.com chat earlier confirmed **bags from 12:00**. It's a lockbox with no reception, so there's nobody to hand bags to — **ask them to confirm in writing that the code works at 12:00.** TP212 lands 10:55; ETA at the door ~12:00.
- [ ] **Porto · save the entry codes offline on two phones** — door `#1111`, lockbox `9391`. Same rule as Zaragoza: no reception desk, the codes are the only way in.
