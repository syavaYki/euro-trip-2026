# Segovia — Sights & Things to Do
## Euro Trip 2026 — Day trip from Madrid (Sep 4)
### AVE from Madrid Atocha → Segovia-Guiomar, 28 min · Return same evening

> Segovia is one of the most perfectly preserved medieval cities in Spain — a Roman aqueduct that needs no cement, a fairy-tale Alcázar perched on a cliff, and a Gothic cathedral rising from the old city plateau. It's 28 minutes from Madrid by high-speed train, and almost no cruise tourists reach it. Plan for a full day.
...
## 🗺️ Suggested Day Route

**09:30 — Arrive Segovia-Guiomar station → taxi/bus to old town**

**10:00 — Roman Aqueduct** (30 min)
Walk the length of the aqueduct from Plaza del Azoguejo — start at the far end and work back toward the main arch. The scale doesn't register in photos.

**10:30 — Walk up into the old city**
Climb the hill from the aqueduct through the medieval streets toward the Cathedral.

**11:00 — Segovia Cathedral** (45 min)
Open by 09:30; go before the day-trip crowds arrive from Madrid by bus.

**12:00 — Lunch in the old city** (see food file)
*Cochinillo asado* (roast suckling pig) is what Segovia is famous for — eat it here.

**13:30 — Alcázar de Segovia** (1.5 hrs)
Give yourself full time — the tower climb and views are the highlight. Last entry usually 18:00 or 19:00.

**15:00 — Jewish Quarter wander + Vera Cruz church** (optional)
The walk down from the Alcázar to Vera Cruz is scenic and passes the Casa de la Moneda.

**16:30 — Coffee + pastry in the Plaza Mayor**
Segovia's central square is quieter and more beautiful than most. *Ponche segoviano* (marzipan layer cake) is the local pastry — try it at any café on the square.

**17:30 — Head back to station** (taxi ~€8 → AVE → back to Madrid ~18:30)
...
| Goal | Answer |
|------|--------|
| If you only do ONE thing | Stand under the Roman Aqueduct — it's incomprehensible in person |
| Best view | Alcázar tower (Torre de Juan II) — 360° over old city + countryside |
| Best photo spot | Mirador below the Alcázar (valley floor looking up at the cliff) |
| Most underrated | Vera Cruz Templar church |
| Skip if short on time | Casa de la Moneda |

---

*Stub — May 2026. Day trip from Madrid Sep 4. Expand with local research before arrival.*
