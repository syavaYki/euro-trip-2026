# 🎒 Packing List — Euro Trip 2026

**4 people · 4 carry-ons + 2 checked bags · 18 days · Aug 19 → Sep 5**
Porto → Lisbon → Barcelona → Zaragoza → Madrid (~~→ Segovia~~ dropped Aug 5)
...
- EWR → OPO (Aug 19) · OPO → LIS (Aug 23) · LIS → BCN (Aug 26)
- **23 kg each · 158 cm total (L+W+H)**
- After BCN they travel by **train**, not plane — no weight rule, but you carry them yourself

**Carry-on — 4 bags, every segment:**

- **8 kg · 55 × 40 × 20 cm** on TAP — this is the limit that actually bites, and TAP weighs at the gate at OPO and LIS
- **56 × 36 × 23 cm, no weight limit** on AA95 home
- Plus 1 personal item each (**40 × 30 × 15 cm**)

**Total capacity: ~78 kg.** Packing is no longer the problem. **Hauling is** — see [Train Days](#-aug-31--sep-1--the-two-train-days).

- [ ] ⚠️ **Confirm both checked bags are pre-paid on all three TAP segments.** The fare is Discount Economy (0PC), so bags are paid extras — and OPO→LIS and LIS→BCN are billed **separately** from the transatlantic leg. Airport prices run roughly double the online rate. [flytap.com](https://www.flytap.com/en-us/baggage/checked-baggage)
- [ ] Weigh every bag at home before Aug 19 — 23 kg checked, 8 kg carry-on
- [ ] **AirTag in each checked bag.** Cheap, and doubly worth it since these sit in a Madrid flat until December
- [ ] Label both checked bags: name, phone, email, and **"HOLD — DECEMBER"**
...
- [ ] Ceramics, azulejo tiles, textiles, leather, books, posters
- [ ] Summer clothes you won't want again before next June
...
- [ ] **Keep each bag under 23 kg** — whoever flies them home in December is still bound by the same limit
- [x] ~~Agree with Emily *when* the handoff happens~~ — **settled: Friday Sep 4, ~08:45, by taxi to her flat at C/ Alonso Cano 4-2A.** Not Sep 5 — the 06:45 airport run can't carry them. ⚠️ **This means everything for these bags is packed by Thursday night, Sep 3**, and it depends on her having keys by Friday — confirm the handover in writing this week
- [ ] Emily's address, phone, and building access saved offline
- [ ] ⚠️ **US customs, December:** the duty-free alcohol allowance is **1 litre per traveller aged 21+**. Only 2 of you qualify. Above that it's declarable — small duty, but declare it
...
- **Barcelona** Aug 26–31 — 28–31 °C and **humid**, sea 24 °C, beach Aug 29
- **Montserrat** Aug 28 — 1,200 m mountain, noticeably cooler and windy, lots of walking
- **Zaragoza** Aug 31 – Sep 1 — hottest stop, **33–36 °C, bone dry**
- **Madrid** Sep 1–5 — 26–32 °C day, **16–19 °C at night**
- ~~**Segovia** Sep 4~~ — ❌ dropped Aug 5 (Emily's UAM day). Sep 4 is now Madrid + **El Pardo** — same Madrid weather, but the Monte de El Pardo is open woodland: hats and water for the midday walk
...
**Renfe rules:** 3 items per passenger, 25 kg total each, max 85 × 55 × 35 cm per bag. Four passengers, so allowance is not the issue — **rack space is**. Both Sants and Atocha have airport-style X-ray security.

- [ ] **Aug 31 — be at Barcelona-Sants by 10:30** for the 11:00 (Coche 6). With 6 bags through security, do not shave this
- [ ] Board early and put the big cases in the **end-of-carriage luggage rack**, not overhead
- [ ] ⚠️ **Zaragoza, Aug 31:** train lands **12:28**, apartment check-in is **16:00** → ~3.5 hours with all 6 bags. Lockers at the **Delicias bus station** (same building, ~€5–8) — **confirm they have large lockers**, or message Isabel about an early bag drop
- [ ] ⚠️ **Zaragoza apartment is 2º Izda with stairs.** Two 23 kg cases up two flights, twice
- [ ] ⚠️ **Sep 1:** check-out **12:00**, train **17:48** → lockers again for ~5.5 hours. Ask Isabel first — a bag hold beats two locker runs
...
- [ ] **Bulk sunscreen SPF 50** — heavy, and half the US price
- [ ] Big water bottles for the apartments
- [ ] Breakfast supplies — the apartments have kitchens, saves ~€40/day
- [ ] Snacks for the train days (Aug 31, Sep 1)
- [ ] Umbrella, **only if Porto actually rains** — €5 at any corner shop
- [ ] Beach mat for Barceloneta, €3
...
- [ ] ❌ Hair dryer / straightener (voltage + weight; apartments have dryers)
- [ ] ❌ Paper books — phone or e-reader
- [ ] ❌ Bath towels — apartments provide them
- [ ] ❌ Travel iron, travel kettle, travel anything
...
- [ ] **At EWR earlier than usual** — TAP bag drop closes 60 min before departure, and you now have 2 bags to check
- [ ] Walking shoes worn, long trousers, the light layer (planes are cold; Porto morning is 18 °C)
- [ ] In the personal item, reachable: eye mask, earplugs or headphones, empty water bottle, toothbrush, phone + power bank, **all 4 passports**
- [ ] Photograph both checked bags at the counter — inside and outside
...
- [ ] All 4 passports in hand, validity checked
- [ ] Bookings printed **and** saved offline (there's no wifi at a Renfe gate)
- [ ] Bag fees confirmed paid on all 3 TAP segments
- [ ] Phones and power banks at 100 %
- [ ] Offline maps + translate packs downloaded
- [ ] Prescriptions in the carry-on, **not** the hold
...
> ⚠️ **The handoff is Friday Sep 4 morning, not today.** The bags go by taxi to Emily's flat at **C/ Alonso Cano 4-2A, 28010** at ~08:45 on Sep 4 — the 06:45 Saturday airport run has neither room nor time for them. **Everything destined for those bags must be packed by Thursday night, Sep 3.** See Madrid Day 4 in the Overview tab.

- [x] Both Madrid bags closed, inventoried, labelled — **done Fri Sep 4 at her flat**
- [ ] Final sweep of the Arganzuela apartment for anything that was supposed to go in them — anything found now flies home in a carry-on or doesn't fly
- [ ] ⚠️ **Nothing over 100 ml in a carry-on.** Every bottle, oil, jam and *vermut* had to go in the Madrid bags **before Friday's handoff** — after that, the only liquid you can fly with is bought airside at MAD (duty-free, sealed STEB bag; JFK is the final stop so the seal holds)
- [ ] Each carry-on under **56 × 36 × 23 cm** — no weight limit on AA, but the size is enforced at the gate
- [ ] Every apartment swept: chargers in wall sockets, bathroom shelves, under beds, in the safe
- [ ] Keys returned per each host's instructions
- [ ] Photo of both Madrid bags where Emily is storing them, with the date — **taken Fri Sep 4 at Alonso Cano 4**

---

_Built against the Aug 19 – Sep 5, 2026 itinerary. Re-check TAP and AA baggage rules the week before travel — they change._
