...
| **Day 3** (Tue Aug 25) | Alfama, Castle & Churches ⭐⭐ 🐌 *(Option B — slow day: 10:30 start, São Vicente + Feira → kiosk lunch → Panteão → Belém, cloister 15:30–17:30 → LX Factory → dinner 20:30. Castle ticket is undated, valid to 1 Nov, so it keeps. Coches museum as a swap for the Alfama afternoon)* 🔀 *(evening Option B: Cristo Rei + Cacilhas dinner instead of fado)* | Castelo 09:00 ✅ → miradouros → **São Vicente ✅** → Feira da Ladra (Tue!) → Panteão → Alfama descent → Sé → tasca lunch 13:30 → cross to Belém → **Jerónimos cloister 15:30 ✅** → **fado dinner at Parreirinha 20:00 🔴 book** |
